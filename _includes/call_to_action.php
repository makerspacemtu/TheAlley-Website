<div class="call-to-action" id="call-to-action">
  <div class="row">
    <div class="small-12 columns">
      ...
      <a href="mailto: makerspace@mtu.edu" class="button" target="_blank">
      ...
      <a href="https://instagram.com/makerspacemtu" class="button" target="_blank">
        <i class="fa fa-instagram"></i>
      </a>
      <a href="https://discord.gg/rwchwXNqWB" class="button">
				Discord
      </a>
    </div>
  </div>
